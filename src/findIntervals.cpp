...
int main(int argc, char** argv)
{
 ...
 /* namedWindow( "Control", 0 ); //para determinar o range de cada cor
  ...
  rect_pub = nh.advertise< ioc::listOfRoi >("ROI",1000);

  message_filters::Subscriber<Image> image_sub(nh, "/husky_1/camera/rgb/image_raw", 1);
  message_filters::Subscriber<Image> depth_sub(nh, "/husky_1/camera/depth/image_raw", 1);
